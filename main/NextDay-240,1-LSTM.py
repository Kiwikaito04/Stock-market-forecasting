...
from src.create_stock_data import create_label_NextDay, create_stock_data_LSTM_NextDay_1f, scalar_normalize, reshaper
...
for test_year in range(START_YEAR + WINDOW_SIZE, END_YEAR + 1):
    ...
    _, df_close = fetch_yfinance_data(TICKERS, start_date, end_date)
