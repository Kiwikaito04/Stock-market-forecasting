...
MODEL_FOLDER = 'report-old/models-Intraday-240-3-4-LSTM'
RESULT_FOLDER = 'report-old/results-Intraday-240-3-4-LSTM'
...
for test_year in range(START_YEAR + WINDOW_SIZE, END_YEAR + 1):
    ...
    model, predictions = trainer_LSTM_I3f240(train_data, test_data, test_year, features=7, folder_save=MODEL_FOLDER)
