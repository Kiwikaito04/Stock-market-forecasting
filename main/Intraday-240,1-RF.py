...
from src.create_stock_data import create_label_RF_Intraday, create_stock_data_RF_Intraday_1f
...
for test_year in range(START_YEAR + WINDOW_SIZE, END_YEAR + 1):
    ...
    for ticker in TICKERS:
        try:
            st_train, st_test = create_stock_data_RF_Intraday_1f(df_open, df_close, label, ticker, test_year)
